...
class JumpDataset(Dataset):
    def __init__(self, experiment_dir, normalize=False, stats_file=None, augmentation=False):
    ...
    def __getitem__(self, idx):
        ...
        target_locations = self.data[TARGET_NAME][idx].reshape(-1, 3) if self.transform_to_base_frame else self.data[TARGET_ID_NAME][idx]
...
def get_dataloaders(data_dir, 
    ...
    train_dataset = JumpDataset(train_data_path, normalize=normalize, augmentation=augmentation)
